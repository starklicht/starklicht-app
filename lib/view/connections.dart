...
class _ConnectionsWidgetState extends State<ConnectionsWidget> {
  ...
  List<String> getPlaceholderTitleAndSubtitle() {
    if (state == BluetoothState.unauthorized ||
      ...
      return [
        "Bluetooth ist nicht verfügbar".i18n,
    ...
    if (state == BluetoothState.off) {
      return [
        "Bluetooth ist aus".i18n,
        "Du kannst Bluetooth in deinen Geräteeinstellungen anschalten".i18n
      ];
    }
    return [
      "Keine aktiven Verbindungen".i18n,
      "Bitte verbinde dich zunächst mit einem Starklicht".i18n
    ];
  }
    ...
    return Scaffold(
      body: Container(
          ...
          child: ListView.builder(
              ...
              itemCount: connectedDevices.isEmpty ||
                      _isLoading ||
                      state == BluetoothState.unknown ||
                ...
                if (_isLoading) {
                  ...
                  return Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            Lottie.asset('assets/rocket.json', width: 500),
                            ...
                            children: [
                              SingleChildScrollView(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text(option.name ?? d.device.name,
                              ...
                              if (option != null) ...[
                                ...
                                Wrap(spacing: 8, runSpacing: 8, children: [
                                  ChoiceChip(
                                      ...
                                      onSelected: (val) {
                                        setState(() {
                                          controller.setOptions(d.device.id.id,
                                              option.withInverse(val));
                                        });
                                      },
                                    ...
                                    onLongPress: () => {
                                      showDialog(
                                          ...
                                          builder: (_) {
                                            ...
                                            t.text = option.delayTimeMillis
                                                .toString();
                                            return AlertDialog(
                                              title: Text(
                                                  "Verzögungsdauer ändern"
                                                      .i18n),
                                              content: TextField(
                                                controller: t,
                                    ...
                                    child: ChoiceChip(
                                        ...
                                        onSelected: (val) {
                                          setState(() {
                                            controller.setOptions(
                                                d.device.id.id,
                                                option.withDelay(val));
                                          });
                                        },
                                        label: Text("Verzögerung (%d ms)"
                                            .i18n
                                            .fill([option.delayTimeMillis]))),
                                  ),
                                  ChoiceChip(
                                      materialTapTargetSize:
                                          MaterialTapTargetSize.shrinkWrap,
  ...
  String getTitle() {
    return _scanning
        ...
        : foundDevices.isEmpty
            ? "Keine Geräte gefunden".i18n
            : "Mit Gerät verbinden".i18n;
  }

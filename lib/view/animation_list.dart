...
class _AnimationsWidgetState extends State<AnimationsWidget> {
  ...
  void send(AnimationMessage animation) {
    controller.broadcast(animation);
  }
                          ...
                          showMenu(
                              ...
                              items: <PopupMenuEntry>[
                                                              ...
                                                              : () {
                                                                  ...
                                                                  Persistence()
                                                                      ...
                                                                      .then((value) => {
                                                                            load(),
                                                                            ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                                                                                content: Text('Animation "%s" wurde zu "%s" umbenannt'.i18n.fill([
                                                                              old!,
                                                                              t.text
                                                                            ])))),
                                ...
                                PopupMenuItem(
                                  child: ListTile(
                                    leading:
                                        const Icon(Icons.delete), // your icon
                                    title: Text("Löschen".i18n),
                                  ),
                                  value: 2,
                                  onTap: () => deleteItem(
                                      filteredAnimations()[realIndex].title!),
                                ),
                              ]);
                        },
                        child: Column(children: [
                          ListTile(
                            ...
                            leading: AnimationPreviewWidget(
                              ...
                              colors: GradientSettingsConfig(
                                  filteredAnimations()[realIndex]
                                      .colors
                                      .map((e) => ColorPoint(e.color, e.point))
                                      .toList()),
                              callback: null,
                            ...
                            subtitle: Text(
                                filteredAnimations()[realIndex].toString()),
                          ),
                          /* Row(

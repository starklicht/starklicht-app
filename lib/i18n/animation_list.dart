...
extension Localization on String {
  ...
  static var t = Translations("de_de") +
      ...
      {
        "de_de":
            'Animation kann jetzt im Abschnitt "Animation" bearbeitet werden',
        "en_us":
            'Animation marked for edit. It can be edited in section "Animation"'
      } +
